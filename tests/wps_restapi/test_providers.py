...
class WpsRestApiProvidersTest(WpsProviderBase):
    ...
    def test_get_provider_process_literal_values(self):
        ...
        assert outputs[0]["formats"][0]["mediaType"] == ContentType.APP_X_NETCDF
        ...
        assert len(outputs[1]["formats"]) == 3
        assert outputs[1]["formats"][0]["mediaType"] == ContentType.TEXT_PLAIN
        assert outputs[1]["formats"][1]["mediaType"] == ContentType.TEXT_HTML
        assert outputs[1]["formats"][2]["mediaType"] == ContentType.APP_PDF
