...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("accept_profile", None, None),
        ("accept_profile", 123456, TypeError),
        ("accept_profile", "ogc", ValueError),
        ("accept_profile", "https://example.com/custom-uri", "https://example.com/custom-uri"),
