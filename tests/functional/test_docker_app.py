...
class WpsPackageDockerAppTest(WpsPackageConfigBase):
    ...
    def wps_execute(self, version, accept):
        ...
        with contextlib.ExitStack() as stack_proc:
            ...
            # execute
            if version == "1.0.0":
                wps_params = {"file": "{}@mimeType={}".format(tmp_file.name, CONTENT_TYPE_TEXT_PLAIN)}
                ...
                wps_params = None
            resp = mocked_sub_requests(self.app, wps_method.lower(), wps_url,
