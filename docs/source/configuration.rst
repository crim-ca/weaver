...
A typical :term:`Data Sources` file is presented below. This sample is also provided in `data_sources.yml.example`_.
...
.. seealso::
    More details about the implication of :term:`Data Sources` are provided in :ref:`data-source`.
