...
.. |commits-since| image:: https://img.shields.io/github/commits-since/crim-ca/weaver/4.32.0.svg
    :alt: Commits since latest release
    :target: https://github.com/crim-ca/weaver/compare/4.32.0...master

.. |version| image:: https://img.shields.io/badge/latest%20version-4.32.0-blue
    :alt: Latest Tagged Version
    :target: https://github.com/crim-ca/weaver/tree/4.32.0
...
.. |github_tagged| image:: https://img.shields.io/github/actions/workflow/status/crim-ca/weaver/tests.yml?label=4.32.0&branch=4.32.0
    :alt: Github Actions CI Build Status (latest tag)
    :target: https://github.com/crim-ca/weaver/actions?query=workflow%3ATests+branch%3A4.32.0
...
.. |docker_build_status| image:: https://img.shields.io/docker/v/pavics/weaver/4.32.0?label=tag%20status
...
::
    ...
    $ docker pull pavics/weaver:4.32.0

For convenience, following tags are also available:

- ``weaver:4.32.0-manager``: `Weaver` image that will run the API for WPS process and job management.
- ``weaver:4.32.0-worker``: `Weaver` image that will run the process job runner application.
