...
.. |commits-since| image:: https://img.shields.io/github/commits-since/crim-ca/weaver/6.9.0-dev3.svg?logo=github
    :alt: Commits since latest release
    :target: https://github.com/crim-ca/weaver/compare/6.9.0-dev3...master

.. |version| image:: https://img.shields.io/badge/latest%20version-6.9.0-dev3-blue?logo=github
    :alt: Latest Tagged Version
    :target: https://github.com/crim-ca/weaver/tree/6.9.0-dev3
...
.. |github_tagged| image:: https://img.shields.io/github/actions/workflow/status/crim-ca/weaver/tests.yml?label=6.9.0-dev3&branch=6.9.0-dev3&logo=github
    :alt: Github Actions CI Build Status (latest tag)
    :target: https://github.com/crim-ca/weaver/actions?query=workflow%3ATests+branch%3A6.9.0-dev3
...
.. |docker_build_status| image:: https://img.shields.io/docker/v/pavics/weaver/6.9.0-dev3?label=tag&logo=docker
...
.. code-block:: shell
    ...
    docker pull pavics/weaver:6.9.0-dev3

For convenience, following tags are also available:

- ``weaver:6.9.0-dev3-manager``: `Weaver` image that will run the API for WPS process and job management.
- ``weaver:6.9.0-dev3-worker``: `Weaver` image that will run the process job runner application.
