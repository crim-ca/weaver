...
.. |commits-since| image:: https://img.shields.io/github/commits-since/crim-ca/weaver/4.16.1.svg
    :alt: Commits since latest release
    :target: https://github.com/crim-ca/weaver/compare/4.16.1...master

.. |version| image:: https://img.shields.io/badge/latest%20version-4.16.1-blue
    :alt: Latest Tagged Version
    :target: https://github.com/crim-ca/weaver/tree/4.16.1
...
.. |github_tagged| image:: https://img.shields.io/github/workflow/status/crim-ca/weaver/Tests/4.16.1?label=4.16.1
    :alt: Github Actions CI Build Status (latest tag)
    :target: https://github.com/crim-ca/weaver/actions?query=workflow%3ATests+branch%3A4.16.1
...
.. |docker_build_status| image:: https://img.shields.io/docker/v/pavics/weaver/4.16.1?label=tag%20status
...
::
    ...
    $ docker pull pavics/weaver:4.16.1

For convenience, following tags are also available:

- ``weaver:4.16.1-manager``: `Weaver` image that will run the API for WPS process and job management.
- ``weaver:4.16.1-worker``: `Weaver` image that will run the process job runner application.
