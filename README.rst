...
.. |commits-since| image:: https://img.shields.io/github/commits-since/crim-ca/weaver/5.6.1.svg
    :alt: Commits since latest release
    :target: https://github.com/crim-ca/weaver/compare/5.6.1...master

.. |version| image:: https://img.shields.io/badge/latest%20version-5.6.1-blue
    :alt: Latest Tagged Version
    :target: https://github.com/crim-ca/weaver/tree/5.6.1
...
.. |github_tagged| image:: https://img.shields.io/github/actions/workflow/status/crim-ca/weaver/tests.yml?label=5.6.1&branch=5.6.1
    :alt: Github Actions CI Build Status (latest tag)
    :target: https://github.com/crim-ca/weaver/actions?query=workflow%3ATests+branch%3A5.6.1
...
.. |docker_build_status| image:: https://img.shields.io/docker/v/pavics/weaver/5.6.1?label=tag%20status
...
.. code-block:: shell
    ...
    docker pull pavics/weaver:5.6.1

For convenience, following tags are also available:

- ``weaver:5.6.1-manager``: `Weaver` image that will run the API for WPS process and job management.
- ``weaver:5.6.1-worker``: `Weaver` image that will run the process job runner application.
