...
def get_conformance(category, settings):
    ...
    ogcapi_proc_conformance = ([
        ...
        f"{ogcapi_proc_core1}/conf/core/conformance-op",
        f"{ogcapi_proc_core1}/conf/core/conformance-success",
        f"{ogcapi_proc_core1}/conf/core/http",
        f"{ogcapi_proc_core1}/conf/core/job-exception-no-such-job",
        f"{ogcapi_proc_core1}/conf/core/job-op",
        ...
        f"{ogcapi_proc_core1}/conf/core/job-results-async-one-multi-valued",
        f"{ogcapi_proc_core1}/conf/core/job-result-op-0th",
        f"{ogcapi_proc_core1}/conf/core/job-result-op-Nth",
        f"{ogcapi_proc_core1}/conf/core/job-results-success-async-one-Nth",
        ...
        # (support pre-filtering with 'outputs' in body already available, above feature is extra at job post-execution)
        f"{ogcapi_proc_core1}/conf/core/job-results-param-outputs",
        f"{ogcapi_proc_core1}/conf/core/job-results-param-outputs-empty",
        f"{ogcapi_proc_core1}/conf/core/job-results-param-outputs-omit",
        f"{ogcapi_proc_core1}/conf/core/job-results-param-outputs-response",
        f"{ogcapi_proc_core1}/conf/core/job-results-success-sync",
        f"{ogcapi_proc_core1}/conf/core/job-success",
        f"{ogcapi_proc_core1}/conf/core/landingpage-op",
        f"{ogcapi_proc_core1}/conf/core/landingpage-success",
        f"{ogcapi_proc_core1}/conf/core/pl-limit-definition",
        f"{ogcapi_proc_core1}/conf/core/pl-limit-response",
        f"{ogcapi_proc_core1}/conf/core/pl-links",
        f"{ogcapi_proc_core1}/conf/core/process-description",
        f"{ogcapi_proc_core1}/conf/core/process-description-success",
        f"{ogcapi_proc_core1}/conf/core/process-description-no-such-process",
        f"{ogcapi_proc_core1}/conf/core/process-execute-auto-execution-mode",
        f"{ogcapi_proc_core1}/conf/core/process-execute-default-execution-mode",
        f"{ogcapi_proc_core1}/conf/core/process-execute-default-outputs",
        f"{ogcapi_proc_core1}/conf/core/process-execute-input-array",
        f"{ogcapi_proc_core1}/conf/core/process-execute-input-inline-bbox",
        f"{ogcapi_proc_core1}/conf/core/process-execute-input-inline-binary",
        f"{ogcapi_proc_core1}/conf/core/process-execute-input-inline-mixed",
        f"{ogcapi_proc_core1}/conf/core/process-execute-input-inline-object",
        f"{ogcapi_proc_core1}/conf/core/process-execute-input-validation",
        f"{ogcapi_proc_core1}/conf/core/process-execute-inputs",
        ...
        f"{ogcapi_proc_core1}/per/core/api-definition-uri",
        ...
        f"{ogcapi_proc_core1}/per/job-list/limit-response",
        f"{ogcapi_proc_core1}/per/job-list/prev",
        # f"{ogcapi_proc_core1}/rec/core/access-control-expose-headers",
        f"{ogcapi_proc_core1}/rec/core/api-definition-oas",
        f"{ogcapi_proc_core1}/rec/core/cross-origin",
        f"{ogcapi_proc_core1}/rec/core/content-length",
    ] + ([
        ...
        f"{ogcapi_proc_core1}/rec/core/link-header",
        f"{ogcapi_proc_core1}/rec/core/ogc-process-description",
        f"{ogcapi_proc_core1}/rec/core/problem-details",
        f"{ogcapi_proc_core1}/rec/core/process-execute-handle-prefer",
        f"{ogcapi_proc_core1}/rec/core/process-execute-honor-prefer",
        f"{ogcapi_proc_core1}/rec/core/process-execute-mode-auto",
        f"{ogcapi_proc_core1}/rec/core/process-execute-preference-applied",
        f"{ogcapi_proc_core1}/rec/core/process-execute-sync-document-ref",
        f"{ogcapi_proc_core1}/rec/core/next-1",
        f"{ogcapi_proc_core1}/rec/core/next-2",
        f"{ogcapi_proc_core1}/rec/core/next-3",
        f"{ogcapi_proc_core1}/rec/core/test-process",
        f"{ogcapi_proc_core1}/rec/job-list/job-list-landing-page",
        f"{ogcapi_proc_core1}/rec/job-list/next-1",
        f"{ogcapi_proc_core1}/rec/job-list/next-2",
        f"{ogcapi_proc_core1}/rec/job-list/next-3",
        f"{ogcapi_proc_core1}/req/callback/job-callback",
        f"{ogcapi_proc_core1}/req/core",
        f"{ogcapi_proc_core1}/req/core/api-definition-op",
        f"{ogcapi_proc_core1}/req/core/api-definition-success",
        f"{ogcapi_proc_core1}/req/core/conformance-op",
        f"{ogcapi_proc_core1}/req/core/conformance-success",
        ...
        f"{ogcapi_proc_core1}/req/core/job-results-async-one-multi-valued",
        f"{ogcapi_proc_core1}/req/core/job-result-op-0th",
        f"{ogcapi_proc_core1}/req/core/job-result-op-Nth",
        f"{ogcapi_proc_core1}/req/core/job-results-success-async-one-Nth",
        ...
        f"{ogcapi_proc_core1}/req/core/job-results-async-raw-value-one",
        f"{ogcapi_proc_core1}/req/core/job-results-success-sync",
        # FIXME: results 'outputs' query parameter (https://github.com/crim-ca/weaver/issues/733)
        # (support pre-filtering with 'outputs' in body already available, above feature is extra at job post-execution)
        f"{ogcapi_proc_core1}/req/core/job-results-param-outputs",
        f"{ogcapi_proc_core1}/req/core/job-results-param-outputs-empty",
        f"{ogcapi_proc_core1}/req/core/job-results-param-outputs-omit",
        f"{ogcapi_proc_core1}/req/core/job-results-param-outputs-response",
        f"{ogcapi_proc_core1}/req/core/job-success",
        f"{ogcapi_proc_core1}/req/core/landingpage-op",
        f"{ogcapi_proc_core1}/req/core/landingpage-success",
        f"{ogcapi_proc_core1}/req/core/pl-links",
        f"{ogcapi_proc_core1}/req/core/process",
        f"{ogcapi_proc_core1}/req/core/process-success",
        f"{ogcapi_proc_core1}/req/core/process-exception/no-such-process",
        f"{ogcapi_proc_core1}/req/core/process-execute-auto-execution-mode",
        f"{ogcapi_proc_core1}/req/core/process-execute-default-execution-mode",
        f"{ogcapi_proc_core1}/req/core/process-execute-default-outputs",
        f"{ogcapi_proc_core2}/req/core/process-execute-empty-outputs"
        f"{ogcapi_proc_core1}/req/core/process-execute-input-array",
        f"{ogcapi_proc_core1}/req/core/process-execute-input-inline-bbox",
        f"{ogcapi_proc_core1}/req/core/process-execute-input-inline-binary",
        f"{ogcapi_proc_core1}/req/core/process-execute-input-mixed-type",
        f"{ogcapi_proc_core1}/req/core/process-execute-input-inline-object",
        f"{ogcapi_proc_core1}/req/core/process-execute-input-validation",
        f"{ogcapi_proc_core1}/req/core/process-execute-inputs",
        f"{ogcapi_proc_core1}/req/core/process-execute-op",
        f"{ogcapi_proc_core2}/req/core/process-execute-omitted-outputs"
        f"{ogcapi_proc_core1}/req/core/process-execute-request",
        ...
        f"{ogcapi_proc_core1}/req/core/process-execute-sync-raw-ref",
        f"{ogcapi_proc_core1}/req/core/process-execute-sync-raw-value-multi",
        f"{ogcapi_proc_core1}/req/core/process-execute-sync-raw-value-one",
        f"{ogcapi_proc_core1}/req/core/pl-limit-definition",
        f"{ogcapi_proc_core1}/req/core/pl-limit-response",
        f"{ogcapi_proc_core1}/req/core/process-list",
        f"{ogcapi_proc_core1}/req/core/process-list-success",
        f"{ogcapi_proc_core1}/req/core/test-process",
        f"{ogcapi_proc_core1}/req/dismiss",
        f"{ogcapi_proc_core1}/req/dismiss/job-dismiss-op",
        f"{ogcapi_proc_core1}/req/dismiss/job-dismiss-success",
    ] + ([
        f"{ogcapi_proc_core1}/req/html",
        ...
        f"{ogcapi_proc_core1}/req/job-list/datetime-response",
        f"{ogcapi_proc_core1}/req/job-list/duration-definition",
        f"{ogcapi_proc_core1}/req/job-list/duration-response",
        f"{ogcapi_proc_core1}/req/job-list/links",
        f"{ogcapi_proc_core1}/req/job-list/jl-limit-definition",
        f"{ogcapi_proc_core1}/req/job-list/job-list-op",
        f"{ogcapi_proc_core1}/req/job-list/processID-definition",
        f"{ogcapi_proc_core1}/req/job-list/processID-mandatory",
        f"{ogcapi_proc_core1}/req/job-list/processid-response",
        f"{ogcapi_proc_core1}/req/job-list/status-definition",
        f"{ogcapi_proc_core1}/req/job-list/status-response",
        f"{ogcapi_proc_core1}/req/job-list/type-definition",
        f"{ogcapi_proc_core1}/req/job-list/type-response",
        f"{ogcapi_proc_core2}/req/kvp-execute",
        f"{ogcapi_proc_core2}/req/kvp-execute/array-input-value",
        f"{ogcapi_proc_core2}/req/kvp-execute/bbox-crs-input-value",
        f"{ogcapi_proc_core2}/req/kvp-execute/bbox-input-value",
        f"{ogcapi_proc_core2}/req/kvp-execute/binary-input-value",
        f"{ogcapi_proc_core2}/req/kvp-execute/binary-input-value-qualified",
        f"{ogcapi_proc_core2}/req/kvp-execute/boolean-input-value",
        f"{ogcapi_proc_core2}/req/kvp-execute/complex-input-value",
        f"{ogcapi_proc_core2}/req/kvp-execute/f-definition",
        f"{ogcapi_proc_core2}/req/kvp-execute/f-response",
        f"{ogcapi_proc_core2}/req/kvp-execute/input-by-reference",
        f"{ogcapi_proc_core2}/req/kvp-execute/input-cardinality",
        f"{ogcapi_proc_core2}/req/kvp-execute/input-query-parameter-values",
        f"{ogcapi_proc_core2}/req/kvp-execute/input-query-parameters",
        f"{ogcapi_proc_core2}/req/kvp-execute/numeric-input-value",
        f"{ogcapi_proc_core2}/req/kvp-execute/output",
        f"{ogcapi_proc_core2}/req/kvp-execute/prefer-definition",
        f"{ogcapi_proc_core2}/req/kvp-execute/prefer-response",
        f"{ogcapi_proc_core2}/req/kvp-execute/process-execute-op",
        f"{ogcapi_proc_core2}/req/kvp-execute/string-input-value",
        f"{ogcapi_proc_core1}/req/oas30",  # OpenAPI 3.0
        f"{ogcapi_proc_core1}/req/oas30/completeness",
        f"{ogcapi_proc_core1}/req/oas30/exceptions-codes",
        f"{ogcapi_proc_core1}/req/oas30/oas-definition-1",
        f"{ogcapi_proc_core1}/req/oas30/oas-definition-2",
        f"{ogcapi_proc_core1}/req/oas30/oas-impl",
        f"{ogcapi_proc_core1}/req/oas30/security",
        f"{ogcapi_proc_core1}/req/ogc-process-description/input-def",
        f"{ogcapi_proc_core1}/req/ogc-process-description/input-mixed-type",
        f"{ogcapi_proc_core1}/req/ogc-process-description/inputs-def",
        f"{ogcapi_proc_core1}/req/ogc-process-description/json-encoding",
        f"{ogcapi_proc_core1}/req/ogc-process-description/output-def",
        f"{ogcapi_proc_core1}/req/ogc-process-description/output-mixed-type",
        f"{ogcapi_proc_core1}/req/ogc-process-description/outputs-def",
        ...
        f"{ogcapi_proc_core2}/req/collection-input/referenced-collection",
        # FIXME: Collection Outputs (https://github.com/crim-ca/weaver/issues/683)
        # f"{ogcapi_proc_core2}/req/collection-output",
        # f"{ogcapi_proc_core2}/req/collection-output/collection-response",
        # f"{ogcapi_proc_core2}/req/collection-output/data-access-mechanisms",
        # f"{ogcapi_proc_core2}/req/collection-output/landing-page",
        # f"{ogcapi_proc_core2}/req/collection-output/landing-page-response",
        # f"{ogcapi_proc_core2}/req/collection-output/response-query-parameter",
        # f"{ogcapi_proc_core2}/per/collection-output/expiry",
        # FIXME: Collection 'properties'
        #  (https://github.com/crim-ca/weaver/issues/750, PR https://github.com/crim-ca/weaver/pull/752)
        # f"{ogcapi_proc_core2}/req/input-fields-modifiers/derived-fields",
        f"{ogcapi_proc_core2}/req/input-fields-modifiers/filtering",
        f"{ogcapi_proc_core2}/req/input-fields-modifiers/sorting",
        # FIXME: Collection Outputs (https://github.com/crim-ca/weaver/issues/683)
        # f"{ogcapi_proc_core2}/req/output-fields-modifiers/derived-fields",
        # f"{ogcapi_proc_core2}/req/output-fields-modifiers/filtering",
        # f"{ogcapi_proc_core2}/req/output-fields-modifiers/sorting",
        f"{ogcapi_proc_core2}/req/remote-collections/collection-access",
        f"{ogcapi_proc_core2}/req/remote-collections/referenced-collection",
        # ------------------------------------------------------------------------
