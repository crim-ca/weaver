...
def api_conformance(request):  # noqa: F811
    ...
    conformance = {"conformsTo": [
        ...
        "https://github.com/opengeospatial/ogcapi-common/blob/Working/collections/requirements/collections/REQ_rc-limit-response.adoc",
        "https://github.com/opengeospatial/ogcapi-common/blob/Working/collections/requirements/collections/REQ_rc-time-collections-response.adoc",
