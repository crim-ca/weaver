...
def includeme(config):
    ...
    config.add_view(q.get_quote_estimator, route_name=sd.process_estimator_service.name,
                    request_method="GET", renderer=OutputFormat.JSON)
    config.add_view(q.update_quote_estimator, route_name=sd.process_estimator_service.name,
                    request_method="PUT", renderer=OutputFormat.JSON)
    config.add_view(q.delete_quote_estimator, route_name=sd.process_estimator_service.name,
